...
const CampCard = ({camp, colNum}) => {
    const {
      ...
      return (
        ...
        <div className={`border-2 rounded-2xl border-teal-400 py-4 px-3  space-y-4 bg-black bg-opacity-60 absolute text-teal-400 bottom-[305px] ${colNum === 3 && "!w-[100%] md:!bottom-80 !right-0"} w-[100%] right-0 md:w-[70%] md:bottom-64 md:right-[15%]`}>
